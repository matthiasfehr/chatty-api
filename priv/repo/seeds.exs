...
Repo.insert!(%GroupUser{user_id: 4, group_id: 3})
Repo.insert!(%GroupUser{user_id: 4, group_id: 2})
Repo.insert!(%GroupUser{user_id: 4, group_id: 4})
Repo.insert!(%GroupUser{user_id: 3, group_id: 4})

Repo.insert!(%Friend{user_id: 1, friend_id: 2})
Repo.insert!(%Friend{user_id: 1, friend_id: 3})
Repo.insert!(%Friend{user_id: 1, friend_id: 4})
Repo.insert!(%Friend{user_id: 3, friend_id: 2})
Repo.insert!(%Friend{user_id: 3, friend_id: 1})
Repo.insert!(%Friend{user_id: 3, friend_id: 4})
Repo.insert!(%Friend{user_id: 2, friend_id: 1})
Repo.insert!(%Friend{user_id: 2, friend_id: 3})
Repo.insert!(%Friend{user_id: 2, friend_id: 4})
Repo.insert!(%Friend{user_id: 4, friend_id: 1})
Repo.insert!(%Friend{user_id: 4, friend_id: 2})
Repo.insert!(%Friend{user_id: 4, friend_id: 3})

for _ <- 1..25 do
  Repo.insert!(%Message{
    text: Faker.Lorem.sentence(20),
    user_id: [1, 2, 3, 4] |> Enum.take_random(1) |> hd,
    group_id: [1, 2, 3, 4] |> Enum.take_random(1) |> hd
  })
end